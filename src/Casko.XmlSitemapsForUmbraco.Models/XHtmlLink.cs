...
public sealed class XHtmlLink
{
    ...
    /// </summary>
    [XmlAttribute(AttributeName = Constants.Rel)]
    ...
    /// </summary>
    [XmlAttribute(AttributeName = Constants.HrefLang)]
    public string HrefLang { get; set; } = null!;

    /// <summary>
    /// Gets or sets the URL of the alternate content version.
    /// This URL should point to the location of the content in the specified language or region.
    /// </summary>
    [XmlAttribute(AttributeName = Constants.Href)]
